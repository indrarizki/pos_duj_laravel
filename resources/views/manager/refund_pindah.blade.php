                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <a class="btn btn-outline-primary" href="{{ route('manager.document.view', $refunds->id) }}">View</a>
                                    </td>
                                </tr>
                                @endforeach
                        </table>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-outline-primary" href="{{ route('manager.document.view', $refund->id) }}">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                            </table>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a class="btn btn-outline-primary" href="{{ route('manager.documents.view', $changes->id) }}">View</a>
                                        </td>
                                    </tr>
                                    @endforeach
                            </table>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>{{ $change_validations->information }}</td> --}}
                                        <td>
                                        <a class="btn btn-outline-primary" href="{{ route('manager.documents.view', $changes->id) }}">View</a>
                                        </td>
                                    </tr>
