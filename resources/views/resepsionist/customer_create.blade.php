    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <form action="{{ route('resepsionist.customer.create')}}" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <label>NIK</label>
                            <input name="nik" type="number" class="form-control" placeholder="NIK sesuai KTP">
                            <label>No Telepon</label>
                            <input name="phone" type="number" class="form-control" placeholder="No Telepon">
                            <label>Alamat</label>
                            <input name="address" type="text" class="form-control" placeholder="Alamat sesuai KTP">
                            <label>Photo</label>
                                <div class="custom-file">
                                <input type="file" class="" name="photo">
                                <label class="">Pilih Foto</label>
                                </div>
                    ...
                    <div class="modal-footer">
                        <a href="{{route('resepsionist.customer.ui')}}" class="btn btn-secondary">Close</a>
